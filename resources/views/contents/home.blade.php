...
@section('content')
    <header class="row tm-welcome-section">
        <h2 class="col-12 text-center tm-section-title">Welcome to HanifCompany</h2>
        <p class="col-12 text-center">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis molestias amet reiciendis exercitationem
            quasi repellendus repellat? Corporis eos ab molestias temporibus fuga praesentium odit numquam consequuntur
            libero rem animi est, nulla ex provident dicta nostrum asperiores doloribus nobis fugit perspiciatis! Quidem aut
            eligendi autem tempora officiis maiores in suscipit consectetur.
        </p>
    </header>
            ...
            <div class="col-md-6">
                <div class="tm-description-box">
                    ...
                    <p class="tm-mb-45">
                        ...
                        is strictly prohibited. You will need to <a rel="nofollow"
                            href="https://templatemo.com/contact">talk to us</a> for additional
